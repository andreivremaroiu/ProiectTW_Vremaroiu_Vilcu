...
router.get('/getAllStatus', bugsController.getAllStatus, 
(req, res) => res.status(200).json(res.locals.data));

// Get all the bugs
router.get('/getAllBugs', bugsController.getAllBugs, 
(req, res) => res.status(200).json(res.locals.data));
...
// Get the total number of bugs
router.get('/count', bugsController.getAllBugsCount, 
(req, res) => res.status(200).json(res.locals.data));
...
// Update the details for a bug
router.post('/:bugId/update', bugsController.updateBug, 
(req, res) => res.status(200).json(res.locals.data));
